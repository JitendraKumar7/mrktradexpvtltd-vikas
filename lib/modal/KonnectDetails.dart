...
class BasicInfo {
  ...
  String _expire;
  List get imageWhatsappBusiness=>_imageWhatsappBusiness;
  ...
  BasicInfo.fromJson(Map<String, dynamic> json) {
    ...
    _email = json['email'];
    _expire=json['expire'];
    _imageWhatsappBusiness=json['imageWhatsappBusiness'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['imageWhatsappBusiness']=this.imageWhatsappBusiness;
