...
class CoverImage extends StatefulWidget{
  ...
  const CoverImage({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return CoverImage1();
  }
}
class CoverImage1 extends State<CoverImage>{
...
//if (!mounted) return;
  ...
  Future<Album> createAlbum(String  title,File password) async {
String tiltr=password.toString();
  //UUID for iOS
...
//if (!mounted) return;
  ...
  'https://meo.co.in/meoApiPro/konnectBusiness/index.php/addCoverImage',
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  " Cover image "??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
