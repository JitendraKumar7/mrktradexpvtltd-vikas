...
class CustomerSupport extends StatefulWidget{
  ...
  const CustomerSupport({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return CustomerSupport1();
  }
}
class CustomerSupport1 extends State<CustomerSupport>{
...
//if (!mounted) return;
  ...
  'https://meo.co.in/meoApiPro/konnectBusiness/index.php/addCustomerSupport',
  ...
  'konnect_id': password,
  'cs_title':title,
  'contact_number':"KonnectBusiness",
  'mail_id':identifier,
  'tollfree_number':deviceVersion,
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  "CustomerSupport"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
