...
class DrugLicense extends StatefulWidget{
  ...
  const DrugLicense ({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return DrugLicense1();
  }
}
class DrugLicense1 extends State<DrugLicense>{
...
//if (!mounted) return;
    ...
    final http.Response response = await http.post(
      'https://meo.co.in/meoApiPro/konnectBusiness_v2/index.php/addDrugLicenceKonnect',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:AppBar(
          title:const  Text(  " Drug Lincense"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
