...
class GalleryHeader extends StatefulWidget{
  ...
  const GalleryHeader({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return GalleryHeader1();
  }
}
class GalleryHeader1 extends State<GalleryHeader>{
...
//if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:AppBar(
          title:const  Text(  "Gallery Header "??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
