...
class Mastercat extends StatefulWidget{
  final int item;

  const Mastercat({Key key, this.item}) : super(key: key);
...
class Mastercat1 extends State<Mastercat>{
  var  konnectid;
...
//if (!mounted) return;
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  "Master Category"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
