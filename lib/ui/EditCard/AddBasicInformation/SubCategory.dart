...
class SubCategory extends StatefulWidget{
  ...
  const SubCategory({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return SubCategory1();
  }
}
class SubCategory1 extends State<SubCategory>{
  var  konnectid;
...
//if (!mounted) return;
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  " Sub Category "??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
