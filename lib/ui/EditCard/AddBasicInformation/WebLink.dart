...
class WabLink extends StatefulWidget{
  final int item;

  const WabLink({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return WabLink1();
  }
}
class WabLink1 extends State<WabLink>{
  var  konnectid;
...
//if (!mounted) return;
  ...
  'https://meo.co.in/meoApiPro/konnectBusiness/index.php/addWebsite',
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  " Web Link"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
