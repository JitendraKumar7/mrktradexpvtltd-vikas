...
class WabStoreHeader extends StatefulWidget{
  final int item;

  const WabStoreHeader({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return WabStoreHeader1();
  }
}
class WabStoreHeader1 extends State<WabStoreHeader>{
...
void navigationPage() {
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  "WebStore Header"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
