...
class WabStoreMessage extends StatefulWidget{
  final int item;

  const WabStoreMessage({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return WabStoreMessage1();
  }
}
class WabStoreMessage1 extends State<WabStoreMessage>{
  var  konnectid;
...
//if (!mounted) return;
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  "WebStore Message"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
