...
class WhatsappMessage extends StatefulWidget{
  ...
  const WhatsappMessage({Key key, this.item}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return WhatsappMessage1();
  }
}
class WhatsappMessage1 extends State<WhatsappMessage>{
...
//if (!mounted) return;
  ...
  return Scaffold(
      appBar:AppBar(
        title:const  Text(  "Whatsapp Message"??"", textAlign: TextAlign.start,style:TextStyle(fontWeight:FontWeight.bold,color: Colors.lightBlue,fontFamily: "Product Sans" ),),),
