...
class withfile extends StatefulWidget {
  final KonnectDetails konnectDetails;

  withfile(this.konnectDetails);
  @override
  createState() => new _withfileState();
}

class _withfileState extends State<withfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      new Scaffold(
                    ...
                    onTap: () async {
                      ...
                      if(   imageInMemory != null) {
                        ...
                        Share.shareFiles([imgFile.path,],
                          ...
                          text: ' Here my BUSINESS CARD with file \n click to see file  on thils link\n'
                              '${addfile}'
          ...
          appBar: new AppBar(
            title: new Text(' Share  with File '),
          ),
          body: Column(
            children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(flaglink==true?details.basicInfo.name:basicInfo.name,style: TextStyle(color: Colors.blue,fontSize: 14,fontWeight: FontWeight.bold),),
                        ),
                        Row(
                          children: [
                            ...
                            Container(
                                ...
                                child:Column(children: [
                                  Row(crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                    Icon(Icons.phone),
                                    Text(flaglink==true?details.basicInfo.mobileNumber:basicInfo.mobileNumber)
                                  ...
                                  Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                          Text(flaglink==true?details.basicInfo.email:basicInfo.email),
                                        ],
                                      ),
                                    )
              ...
              Row(children: [
                ...
                Expanded(child: Text("")),
                Expanded(child: addfile==""?IconButton( icon:Icon( Icons.add,size: 40,),onPressed: (){   attachedFileDialog(context, "2");},):Container(child: Text("FILE UPLOADED SUCCESSFULLY",style: TextStyle(color:Colors.red),),)),
              ],),
              addfile!=""?Container(height:Height*0.42,width:Width*0.65,child: Image.network(addfile)):Container()
