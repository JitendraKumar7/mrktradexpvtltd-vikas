...
class withgpslocation extends StatefulWidget {
  final KonnectDetails konnectDetails;

  withgpslocation(this.konnectDetails);
  @override
   createState() => new _withgpslocationState();
}

class _withgpslocationState extends State<withgpslocation> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      new Scaffold(
                    ...
                    onTap: () async {
                      ...
                      if(   imageInMemory != null) {
                        ...
                        Share.shareFiles([imgFile.path,],
                          ...
                          text: ' Here my BUSINESS CARD with \n GPS link to my location \n click to start navigaton \n'
                              'http://maps.google.com/maps?q=${location[0].latitude},${location[0].longitude}',
          ...
          appBar: new AppBar(
            title: new Text(' Share With Location '),
          ),
          body: Column(
            children: [
                                ...
                                child:Column(children: [
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                          Text(flaglink==true?details.basicInfo.email.trim():basicInfo.email),
                                        ],
                                      ),
                                    )
