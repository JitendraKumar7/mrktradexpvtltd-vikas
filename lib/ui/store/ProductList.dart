                  ...
                  itemBuilder: (context, index) {
                    ...
                    //  String desc = "<bold>Hello<bold> World";
                      ...
                      Share.shareFiles([imgFile.path],
                       subject: '${AppConstants.SHARE_APP} ${AppConstants().SHARE_WEBVIEW} https://meo.co.in/konnect-link/konnect-new/productMart/singleProduct.php?kid=$AppConstants.konnect_id=&subcid=${""}&pid=MTU',
                       text: '*${_list[index].name} , Price: ₹ ${_list[index].tradePrice} ,   Specification: ${_list[index].specification1},${_list[index].specification2},${_list[index].specification3} ,*   ${AppConstants.SHARE_APPproduct} ${AppConstants().SHARE_STORE}         *For More Information Contact:9651222333*',
                      // sharePositionOrigin: box.localToGlobal(Offset.zero) & box.size);
                     //  text:''
                   );
                    },
